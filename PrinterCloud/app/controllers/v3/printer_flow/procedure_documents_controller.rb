    ...
    class ProcedureDocumentsController < BaseController
      ...
      def index
        ...
        render json: procedure_documents, meta: { total: procedure_documents.count },
               each_serializer: V3::ProcedureDocumentSerializer::List, adapter: :json, status: :ok
      end
      ...
      def show
        ...
        render json: procedure_document, serializer: V3::ProcedureDocumentSerializer::Show,
               status: :ok
      end
      ...
      def create
        ...
        render json: procedure_document, serializer: V3::ProcedureDocumentSerializer::Show, status: :created
      end
      ...
      def create_params
        params.require(:procedure_document).permit(:s3_key, :name).merge(created_by_id: current_user.id,
