class CreateGroupRequesterInfos < ActiveRecord::Migration[6.1]
  def up
    execute 'CREATE SCHEMA IF NOT EXISTS printer_flow'

    create_table 'printer_flow.group_requester_infos' do |t|
  ...
  def down
    drop_table 'printer_flow.group_requester_infos'
  end
end
