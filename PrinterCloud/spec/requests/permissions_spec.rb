...
RSpec.describe 'Permissions', type: :request do
  ...
  let!(:permission) do
    create(:permission, user: user2, directory_id: directory.id, permission_granted_by: user, scope: 0)
  end

  describe 'GET /index' do
    it 'renders a successful response' do
      get permissions_url, headers: authorization_headers, as: :json
  ...
  describe 'GET /show' do
    it 'renders a successful response' do
      permission = Permission.create! scope: 0, user: user2, document_id: document.id, permission_granted_by: user
      get "/permissions/#{permission.id}", headers: authorization_headers, as: :json
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      ...
      it 'creates a new Permission' do
        expect do
          post '/permissions', params: params, headers: authorization_headers, as: :json
    ...
    context 'with user_id equals permission_granted_by_id' do
      ...
      it 'returns error message' do
        post permissions_url, params: params, headers: authorization_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      it 'updates the requested permission' do
        ...
        patch "/permissions/#{permission.id}", params: { permission: valid_attributes },
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested permission' do
      expect do
        delete "/permissions/#{permission.id}", headers: authorization_headers, as: :json
      end.to change(Permission, :count).by(-1)
    end
  end
end
