...
RSpec.describe 'Base', type: :request do
  ...
  describe 'GET /v2/air/organization_member/organizations/:id/healthcheck' do
    context 'when user is organization member' do
      ...
      it 'responds with status ok' do
        get "/v2/air/organization_member/organizations/#{organization.id}/healthcheck", headers: authorization_headers
