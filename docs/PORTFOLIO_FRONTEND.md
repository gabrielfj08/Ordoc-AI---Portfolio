...
> **Ordoc AI** é uma plataforma inteligente voltada para a gestão de processos, análise de dados e fluxos de documentos médicos/administrativos. Este repositório contém a aplicação **Frontend** construída sob uma arquitetura moderna, escalável e focada na melhor experiência de uso (UX) e performance.
