  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <p className="text-gray-600 mb-4">
        Gerencie usuários do sistema de forma simplificada.
      </p>
      <div className="space-y-2">
        <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded">
          <span className="text-sm text-gray-700">Total de usuários</span>
        ...
        <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded">
          <span className="text-sm text-gray-700">Usuários inativos</span>
