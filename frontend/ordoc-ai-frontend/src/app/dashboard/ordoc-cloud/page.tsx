...
export default function OrdocCloudPage() {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">OrdocCloud</h1>
                  <p className="text-sm text-gray-500">Gestão de organizações, usuários e políticas</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 mb-8 text-white">
            <div className="max-w-3xl">
              <h2 className="text-3xl font-bold mb-4">Seja bem-vindo ao OrdocCloud!</h2>
              <p className="text-blue-100 text-lg mb-6">
                Gerencie sua organização, usuários e políticas de acesso de forma centralizada e segura. 
