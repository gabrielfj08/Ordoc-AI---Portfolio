            ...
            <div className="lg:col-span-2 p-2 flex flex-col justify-center">
                ...
                <div className="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-3 tracking-tight">Boa tarde, Ricardo</h1>
                    ...
                    <div className="hidden sm:block text-right">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">Prazos críticos: 3 documentos vencem hoje</p>
                    </div>
                </div>
                ...
                <div className="mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-border/50 self-start">
                    ...
                    <span className="text-sm font-medium text-foreground">Operando em Prefeitura de Curitiba • Sec. Jurídica</span>
                </div>

            </div>

            {/* Stats Card - Orange Gradient */}
            <div className="rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 flex flex-col justify-between bg-gradient-to-br from-orange-500 to-orange-600 text-white animate-in fade-in slide-in-from-bottom-5 duration-700 relative overflow-hidden group min-h-[200px]">
                ...
                <div>
                    <p className="text-xs uppercase tracking-widest text-orange-100 font-bold">Estado dos Processos</p>
                    <div className="mt-2 text-2xl font-bold tracking-tight">Carga: moderada</div>
                </div>

                <div className="mt-6 flex items-start justify-between">
                    <div className="flex flex-col">
                        <span className="text-orange-100/80 text-sm font-medium mb-1">Urgente</span>
                        <span className="font-bold text-3xl">8</span>
                    </div>
                    <div className="flex flex-col border-l border-white/20 pl-6">
                        <span className="text-orange-100/80 text-sm font-medium mb-1">Normal</span>
                        <span className="font-bold text-3xl">24</span>
                    </div>
                    <div className="flex flex-col border-l border-white/20 pl-6">
                        <span className="text-orange-100/80 text-sm font-medium mb-1">Concluídas</span>
                        <span className="font-bold text-3xl">156</span>
                    </div>
                </div>
            </div>
        </section>
