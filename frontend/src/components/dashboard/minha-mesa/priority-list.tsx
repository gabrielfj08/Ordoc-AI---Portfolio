                    ...
                    <div className="space-y-2 animate-in fade-in zoom-in-95 duration-300">
                        ...
                        <article className="group bg-card hover:bg-accent/50 cursor-pointer border border-border hover:border-primary/30 rounded-xl p-3 flex gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                            <div className="mt-0.5">
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-destructive/10 text-destructive text-sm font-semibold">
                            ...
                            <div className="flex-1 flex flex-col gap-1">
                                <div className="flex items-center justify-between gap-2">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs uppercase tracking-wider text-muted-foreground font-medium">Vence em 2 horas</span>
                                    </div>
                                ...
                                <div className="flex flex-wrap items-center gap-2 mt-1.5">
                                    <Button size="sm" className="h-7 text-xs rounded-full px-3">Assinar agora</Button>
                                    <Button variant="outline" size="sm" className="h-7 text-xs rounded-full px-3">Ver documento</Button>
                                </div>
                            </div>
                        </article>
                        ...
                        <article className="group bg-card hover:bg-accent/50 cursor-pointer border border-border hover:border-primary/30 rounded-xl p-3 flex gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                            <div className="mt-0.5">
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-400 text-sm font-semibold">
                            ...
                            <div className="flex-1 flex flex-col gap-1">
                                <div className="flex items-center justify-between gap-2">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs uppercase tracking-wider text-muted-foreground font-medium">Vence em 4 horas</span>
                                    </div>
                                    <span className="text-xs px-2 py-0.5 rounded-full bg-secondary text-muted-foreground font-mono">
                                        #1156
                                    </span>
                                ...
                                <div className="flex flex-wrap items-center gap-2 mt-1.5">
                                    <Button size="sm" className="h-7 text-xs rounded-full px-3">Aprovar</Button>
                                    <Button variant="outline" size="sm" className="h-7 text-xs rounded-full px-3">Ver histórico</Button>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                {activeTab === 'assinaturas' && (
                    <div className="space-y-2 animate-in fade-in zoom-in-95 duration-300">
                        <article className="group bg-card hover:bg-blue-50/50 dark:hover:bg-blue-900/20 cursor-pointer border border-blue-100 dark:border-blue-800 hover:border-blue-300 rounded-xl p-3 flex gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                            <div className="mt-0.5">
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 text-sm font-semibold">
                            ...
                            <div className="flex-1 flex flex-col gap-1">
                                <div className="flex items-center justify-between gap-2">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs uppercase tracking-wider text-blue-500 font-medium">Aguardando assinatura</span>
                                    </div>
                                </div>
                                <p className="text-sm text-muted-foreground leading-snug">
                                ...
                                <div className="flex flex-wrap items-center gap-2 mt-1.5">
                                    <Button size="sm" className="h-7 text-xs rounded-full px-3 bg-blue-600 hover:bg-blue-700 text-white">Assinar com e-CNPJ</Button>
                                </div>
                            </div>
                        </article>
                    </div>
