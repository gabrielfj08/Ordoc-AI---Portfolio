                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-16">
                            <div className="flex items-center space-x-4">
                                <Link href="/dashboard/ordoc-flow/groups" className="text-gray-500 hover:text-gray-700">
                                    <ArrowLeftIcon className="w-6 h-6" />
                                </Link>
                                <h1 className="text-2xl font-bold text-gray-900">Grupos Externos</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8">
                    <div className="text-center max-w-md mx-auto">
                        ...
                        <p className="text-gray-500 mb-8">
                            Gestão de grupos externos
                        </p>
                        <div className="flex justify-center space-x-4">
                            <Link href="/dashboard/ordoc-flow/groups">
