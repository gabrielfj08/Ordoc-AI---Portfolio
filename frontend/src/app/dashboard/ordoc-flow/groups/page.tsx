...
export default function GroupsSelectionPage() {
    const options = [
        {
            title: 'Grupos de Trabalho',
            description: 'Gerenciar grupos e permissões de fluxo de trabalho',
            icon: UsersIcon,
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-16">
                            <div className="flex items-center space-x-4">
                                <Link href="/dashboard/ordoc-flow" className="text-gray-500 hover:text-gray-700">
