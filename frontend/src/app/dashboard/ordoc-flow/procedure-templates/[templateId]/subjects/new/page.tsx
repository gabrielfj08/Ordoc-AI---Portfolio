...
const NewSubjectPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await subjectsService.createSubject(submitData);
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Novo Campo</h1>
            <p className="text-gray-600">Adicione um novo campo ao formulário do procedimento</p>
          </div>
        </div>
      </div>
