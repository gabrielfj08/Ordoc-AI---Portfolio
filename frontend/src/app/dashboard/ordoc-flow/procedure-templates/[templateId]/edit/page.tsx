...
import { ProcedureTemplate, FormErrors } from '@/types/ordoc-flow';
import ErrorState from '@/components/ui/ErrorState';

const EditProcedureTemplatePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await procedureTemplatesService.updateProcedureTemplate(templateId, formData);

      if (response.success) {
        router.push(`/dashboard/ordoc-flow/procedure-templates/${templateId}`);
      } else {
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Editar Template de Procedimento</h1>
            <p className="text-gray-600">Atualize as informações do template</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Templates ativos podem ser utilizados para criar procedimentos
                </p>
              </div>
            </div>
          </div>
