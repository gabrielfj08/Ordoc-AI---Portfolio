...
const EditRequesterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await requestersService.updateRequester(requesterId, formData);

      if (response.success) {
        router.push(`/dashboard/ordoc-flow/requesters/${requesterId}`);
      } else {
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Editar Requerente</h1>
            <p className="text-gray-600">Atualize as informações do requerente</p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Digite o e-mail do requerente"
                />
                {errors.email && (
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Digite o documento do requerente (CPF/CNPJ)"
                />
                {errors.document && (
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Requerentes internos são membros da organização
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Requerentes ativos podem criar procedimentos no sistema
                </p>
              </div>
            </div>
          </div>
...
export default EditRequesterPage;
