...
export default function OrganizationsPage() {
  ...
  const [sortBy, setSortBy] = useState('corporate_name');
  ...
  const organizations: Organization[] = [
    {
      id: 'c79be239-f498-4f3f-a852-b5f386b5cde9',
      corporate_name: 'Demo Organization LTDA',
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-gray-900">Organizações</h1>
                    <p className="text-sm text-gray-500">Gerencie organizações e filiais</p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  <option value="corporate_name-asc">Nome A-Z</option>
                  <option value="corporate_name-desc">Nome Z-A</option>
                  ...
                  {organizations.map((org) => (
                    <tr key={org.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{org.corporate_name}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                          <Link
                            href={`/dashboard/ordoc-cloud/organizations/${org.id}`}
                            className="text-blue-600 hover:text-blue-900"
                          >
                            Visualizar
                          </Link>
                          <Link
                            href={`/dashboard/ordoc-cloud/organizations/${org.id}/edit`}
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    Mostrando <span className="font-medium">1</span> a <span className="font-medium">{organizations.length}</span> de{' '}
                    <span className="font-medium">{organizations.length}</span> resultados
                  </p>
                </div>
                <div>
