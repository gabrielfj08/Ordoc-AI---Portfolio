...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect directly to the appropriate page based on login result
      console.log('🔄 Login successful - checking password change requirement');
      console.log('🔑 Must change password:', result.mustChangePassword);

      // Direct redirect without intermediate transition page
      setTimeout(() => {
              ...
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  <div className="bg-white border border-blue-600 rounded-lg px-4 py-2 shadow-sm flex items-center gap-2 text-sm">
                    <div className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-colors ${turnstileToken
