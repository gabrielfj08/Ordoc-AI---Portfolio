...
import { GroupRequestersPageProps } from './types';
import GroupsTable from '../components/Groups/Table';
import Pagination from '../../components/Pagination/Pagination';
import GroupRequestersSortSelect from '../components/Groups/Select';
import { sortMapping, sortOptions } from '../components/Groups/Select';
import FlowFilterButton from '../components/FilterButton';
import Filter from './Filter';

const GroupRequestersPage = ({
  setParams,
  params,
}: GroupRequestersPageProps) => {
    ...
    <div className="w-full mb-12">
      <div className="sm:flex sm:space-x-2.5 space-y-4 sm:space-y-0 my-6 px-3">
        <Button
          ...
          onClick={() => router.push('/printer-flow/groups/new')}
        >
          <Button.Icon
            alt="plus"
            name="plus"
      ...
      <div className="px-2 sm:px-0 sm:mr-10">
        <GroupsTable params={params} setTotalObjects={setTotalObjects} />
      </div>
    </div>
  );
};

export default GroupRequestersPage;
