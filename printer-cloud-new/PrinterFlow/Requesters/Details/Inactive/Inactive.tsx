...
import { InactiveRequesterDetailsProps } from './types';

const InactiveRequesterDetails = ({
  justificationNote,
}: InactiveRequesterDetailsProps) => {
  const boxClassName =
  ...
  return (
    <>
      <div className={boxClassName}>
        ...
        <div className="space-y-2">
          <Typography variant="footnote1" family="robotoMedium">
            Usuário que desativou o solicitante:
          </Typography>
      ...
      <div className={boxClassName}>
        <Icon name="write" alt="requester" stroke fill w={26} h={26} />
        <div className="space-y-2">
          <Typography variant="footnote1" family="robotoMedium">
...
export default InactiveRequesterDetails;
