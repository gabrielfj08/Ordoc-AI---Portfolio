...
const EditRequesterUnauthorized = () => {
  return (
    <div className="flex justify-center items-center my-20 sm:mr-10 space-x-3 p-4 py-7 mx-5 sm:w-11/12 sm:ml-0 ml-3 w-80 border border-lighterGray">
...
export default EditRequesterUnauthorized;
