...
import {
  ...
  NewProcedureTemplateDocumentModalProps,
} from './types';

const NewProcedureTemplateDocumentModal = ({
  onSubmit,
}: NewProcedureTemplateDocumentModalProps) => {
  ...
  return (
    <ActionBox>
      ...
      <Formik
        ...
        onSubmit={(values: NewProcedureTemplateDocumentFormValues) => {
          onSubmit(values);
...
export default NewProcedureTemplateDocumentModal;
