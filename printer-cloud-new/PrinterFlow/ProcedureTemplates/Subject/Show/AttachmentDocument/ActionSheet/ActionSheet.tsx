...
import { UploadDocumentActionSheetProps } from './types';
import SubjectDocumentUploadContainer from '../SubjectUploadDocument';

const UploadDocumentActionSheet = ({
  attachmentUploadIds,
}: UploadDocumentActionSheetProps) => {
        ...
        <div className="bg-white border-2 border-lightGray rounded-lg p-5">
          ...
          <Disclosure.Panel>
            <div className="flex flex-col gap-4 pt-5 max-h-[50vh] overflow-y-auto">
              {attachmentUploadIds.map((attachmentUploadId) => (
                <SubjectDocumentUploadContainer
                  id={attachmentUploadId}
                  key={attachmentUploadId}
                />
              ))}
            </div>
          </Disclosure.Panel>
...
export default UploadDocumentActionSheet;
