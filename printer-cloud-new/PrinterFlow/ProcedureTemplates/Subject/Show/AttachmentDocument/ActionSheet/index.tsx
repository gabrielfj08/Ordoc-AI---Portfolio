...
import { CreateProcedureTemplateDocumentAPIResponse } from '../../../../../../services/printer-flow/types';
import { SubjectUploadDocumentContainerProps } from './types';
import UploadDocumentActionSheet from './ActionSheet';

const appEnv = getConfig().publicRuntimeConfig.NEXT_PUBLIC_APP_ENV;

const SubjectActionSheetContainer = ({
  fileList,
  procedureTemplateDocument,
  procedureTemplate,
}: SubjectUploadDocumentContainerProps) => {
  ...
  return (
    <UploadDocumentActionSheet attachmentUploadIds={uploadAttachmentIds} />
  );
};

export default SubjectActionSheetContainer;
