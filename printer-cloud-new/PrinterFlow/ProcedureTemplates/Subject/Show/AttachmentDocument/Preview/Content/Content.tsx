...
import { SubjectDocumentsModalContentProps } from './types';

const SubjectDocumentsModalContent = ({
  src,
}: SubjectDocumentsModalContentProps) => {
...
export default SubjectDocumentsModalContent;
