...
import { ShowFieldSubjectEmptyProps } from './types';
import NewField from '../../../../components/ProcedureTemplates/NewField';

const ShowFieldSubjectEmpty = ({
  procedureTemplate,
}: ShowFieldSubjectEmptyProps) => {
      ...
      {hidden === 'hidden' ? (
        <div className="w-full bg-white flex items-center space-x-2 justify-center my-4 py-4">
          ...
          <Typography variant="footnote1" color="gray" align="center">
            Você ainda não possui nenhum campo no assunto.
          </Typography>
        </div>
      ) : null}
    </div>
...
export default ShowFieldSubjectEmpty;
