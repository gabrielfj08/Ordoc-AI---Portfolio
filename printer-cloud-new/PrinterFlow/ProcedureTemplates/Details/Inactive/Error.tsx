...
const InactiveProcedureTemplateDetailsError = () => {
  return (
    <div className="h-96 sm:p-0 px-14 items-center justify-center flex w-full space-x-2">
      ...
      <Typography variant="footnote2" color="gray" align="center">
        Erro! Não foi possível carregar os detalhes de desativação do processo,
...
export default InactiveProcedureTemplateDetailsError;
