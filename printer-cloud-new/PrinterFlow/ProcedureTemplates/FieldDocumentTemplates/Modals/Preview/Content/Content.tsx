...
import { FieldDocumentTemplateModalContentProps } from './types';

const FieldDocumentTemplateModalContent = ({
  src,
}: FieldDocumentTemplateModalContentProps) => {
...
export default FieldDocumentTemplateModalContent;
