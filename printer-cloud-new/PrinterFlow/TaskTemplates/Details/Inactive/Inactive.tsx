...
import { InactiveTaskTemplateDetailsProps } from './types';

const InactiveTaskTemplateDetails = ({
  justificationNotes,
}: InactiveTaskTemplateDetailsProps) => {
  const boxClassName =
      ...
      <div className={boxClassName}>
        ...
        <div className="space-y-2 w-full">
          <Typography variant="footnote1" family="robotoMedium" align="center">
            Usuário que desativou o tipo de tarefa:
          </Typography>
...
export default InactiveTaskTemplateDetails;
