...
import { TaskTemplatesProps } from './types';
import TaskTemplatesSortSelect, { sortMapping, sortOptions } from './Select';
import Pagination from '../../components/Pagination';
import TaskTemplateFilter from './Filter';
import FilterButtonTaskTemplates from '../components/TaskTemplates/FilterTaskTemplates';
import TaskTemplatesTable from '../components/TaskTemplates/Table';

const TaskTemplates = ({ params, setParams }: TaskTemplatesProps) => {
  ...
  return (
    <div className="w-full mb-12">
      <div className="sm:flex sm:space-x-2.5 space-y-4 sm:space-y-0 my-6 px-3">
        <Button
          onClick={() => {
            router.push(`/printer-flow/task-templates/new`);
          }}
      ...
      <div className="sm:pr-10 px-2">
        <TaskTemplatesTable params={params} setTotalObjects={setTotalObjects} />
      </div>
    </div>
  );
};
