...
const ProcedureTemplatesTableSkeleton = () => {
  const RowSkeleton = () => {
    return (
      <div className="h-20 flex w-full border-b border-lighterGray">
        <div className="w-10/12 sm:w-5/12 h-full flex items-center pl-4">
        ...
        <div className="hidden sm:flex w-3/12 sm:w-2/12 h-full space-x-2 items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="border border-lighterGray mx-2">
        <div className="h-20 flex w-full  border-b border-lighterGray">
          <div className="w-10/12 sm:w-5/12 h-full space-x-4 flex items-center pl-4">
          ...
          <div className="hidden sm:flex w-3/12 sm:w-2/12 h-full items-center justify-center">
            <Skeleton w={14} h={5} rounded="default" />
          </div>
...
export default ProcedureTemplatesTableSkeleton;
