...
describe('Task table cell', () => {
  it('renders the Task name cell', () => {
    const taskCell = render(<TaskCell task={testTask} />);

    const { getByText } = taskCell;

    expect(getByText('Assinar documento')).toBeInTheDocument();
  });
});
