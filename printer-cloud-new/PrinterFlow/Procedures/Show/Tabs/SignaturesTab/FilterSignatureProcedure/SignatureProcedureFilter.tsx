...
import { SignatureProcedureFilterButtonProps } from './types';

const SignatureProcedureFilterButton = ({
  children,
  params,
  setParams,
}: SignatureProcedureFilterButtonProps) => {
  return (
...
export default SignatureProcedureFilterButton;
