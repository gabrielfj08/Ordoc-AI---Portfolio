...
import { ArchiveProcedureModalProps } from './types';

const ArchiveProcedureModal = ({
  onSubmit,
  processNumber,
}: ArchiveProcedureModalProps) => {
      ...
      <Formik
        ...
        onSubmit={(values, actions) => {
          onSubmit(values)
            .then(() => {
              closeModal();
              showSnackbar(`Processo arquivado com sucesso.`, 'success');
            })
            .catch((error) => {
              ...
              <div className="sm:w-[569px] space-y-4">
                <div className="overflow-hidden sm:w-auto w-72">
                  <Typography variant="headline" family="roboto">
                    Está ação irá arquivar o processo:
                  </Typography>
                </div>
                <Typography
                  variant="headline"
                ...
                <Typography variant="headline" family="roboto">
                  Ao clicar em arquivar processo, ele será arquivado, porém
                  poderá ser desarquivado a qualquer momento.
                </Typography>
                <span className="flex space-x-2 justify-start items-center pt-2">
                  ...
                  <label htmlFor="checkbox" className="cursor-pointer">
                    <Typography variant="headline" family="roboto">
                      Estou ciente que irei arquivar o processo.
                    </Typography>
                  </label>
                </span>
                ...
                <Typography variant="headline" family="robotoMedium">
                  Descreva a justificativa do arquivamento*:
                </Typography>
...
export default ArchiveProcedureModal;
