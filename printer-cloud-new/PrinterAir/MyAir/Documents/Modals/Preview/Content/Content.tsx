...
import { PreviewDocumentModalContentProps } from './types';

const apiUrl = getConfig().publicRuntimeConfig.NEXT_PUBLIC_API_URL;

const PreviewDocumentModalContent = ({
  document,
}: PreviewDocumentModalContentProps) => {
...
export default PreviewDocumentModalContent;
