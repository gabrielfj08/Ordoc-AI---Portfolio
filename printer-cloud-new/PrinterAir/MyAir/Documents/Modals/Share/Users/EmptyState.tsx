...
const ShareDocumentModalUserListItemEmptyStatus = () => {
  return (
    <div className="border border-lighterGray flex items-center space-x-2 justify-center py-4">
      ...
      <Typography variant="footnote1" color="gray" align="center">
        Este documento ainda não está compartilhado com nenhum usuário!
      </Typography>
    </div>
  );
};

export default ShareDocumentModalUserListItemEmptyStatus;
