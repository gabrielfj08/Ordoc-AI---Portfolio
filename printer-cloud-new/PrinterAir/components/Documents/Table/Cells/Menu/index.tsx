...
const MenuCellContainer = ({ document }: MenuCellContainerProps) => {
  ...
  const options: menuOptions[] = [
    ...
    },
    {
      ...
      fill: true,
      onClick: () =>
        openActionSheet(<DocumentOCRJob selectedDocumentIds={[document.id]} />),
      label: 'OCR',
      stroke: false,
      disabled: document.status === 'enqueued' ? true : false,
    },
    {
      icon: 'write',
      fill: true,
    ...
    },
    {
      icon: 'versionsV2',
      fill: true,
      onClick: () => openModal(<DocumentVersionModal document={document} />),
    ...
    },
    {
      icon: 'duplicateV2',
      fill: true,
      onClick: () => openActionSheet(<DocumentCopyJobs document={document} />),
      label: 'Duplicar',
      stroke: false,
    },
    {
    ...
    },
    {
      ...
      fill: false,
      onClick: () =>
        openDrawer(<DocumentProperties documentId={document.id} />, 'right'),
      label: 'Propriedades',
      stroke: true,
    },
    {
