...
import RecoverUnlockPasswordForm from '../../FlowCidadao/RecoverUnlockPassword';
...
const RecoverUnlockPasswordPage = ({ secret }) => {
  return (
    <div className="bg-[url(/assets/login-bg-flow-cidadao-mb.png)] sm:bg-[url(/assets/login-bg-flow-cidadao.png)] bg-bottom min-h-screen min-w-full bg-cover align-bottom grid">
      <Head>
        <title>Flow Cidadão | Recuperar ou desbloquear conta</title>
      </Head>
      <main>
        ...
        <RecoverUnlockPasswordForm secret={secret} />
      </main>
