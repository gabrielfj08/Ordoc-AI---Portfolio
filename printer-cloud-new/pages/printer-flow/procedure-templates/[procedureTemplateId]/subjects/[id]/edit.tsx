...
import EditSubject from '../../../../../../PrinterFlow/ProcedureTemplates/Subject/Edit';
import { SessionGroupRequesterProvider } from '../../../../../../hooks';
import { NextPageWithLayout } from '../../../../../_app';

const EditSubjectPage: NextPageWithLayout = () => {
  return (
    <>
      <Head>
        <title> Printer Flow | Editar assunto</title>
      </Head>
...
EditSubjectPage.getLayout = (page: React.ReactElement) => {
  return (
