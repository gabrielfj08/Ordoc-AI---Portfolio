...
import { SignExternalSignatureAPIResponse } from '../../../../../../../services/flow-cidadao/types';

const transformData = (data): SignExternalSignatureAPIResponse => {
  return {
    id: data.id,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .put(
      `/v3/printer_flow/external/signatures/${req.query.signatureId}/sign`,
      {},
      config
    )
    .then((response) => {
