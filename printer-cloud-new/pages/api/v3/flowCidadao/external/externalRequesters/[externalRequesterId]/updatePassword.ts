...
import { UpdatePasswordAPIResponse } from '../../../../../../../services/flow-cidadao/types';
import { camelToSnake } from '../../../../../../../utils';

const transformData = (data): UpdatePasswordAPIResponse => {
  return {
    id: data.id,
    name: data.name,
    email: data.email,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .put(
      `/v3/printer_flow/external/external_requesters/${req.query.externalRequesterId}/update_password`,
