...
import { AcceptExternalTaskAPIResponse } from '../../../../../../../services/flow-cidadao/types';

const transformData = (data): AcceptExternalTaskAPIResponse => {
  return {
    id: data.id,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .put(
      `/v3/printer_flow/external/tasks/${req.query.taskId}/accept`,
      {},
      config
    )
    .then((response) => {
