...
import { DeleteProcedureDocumentAPIResponse } from '../../../../../../../../../services/flow-cidadao/types';
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .delete(
      `/v3/printer_flow/external/procedures/${req.query.procedureId}/procedure_documents/${req.query.documentId}`,
      config
    )
    .then((response) => {
