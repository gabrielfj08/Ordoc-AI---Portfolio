...
import { PutAttachPolicyToUserAPIResponse } from '../../../../../../services/types';

const transformData = (data): PutAttachPolicyToUserAPIResponse => {
  return {
    id: data.id,
    name: data.name,
    prn: data.prn,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .put(
      `/v3/printer_cloud/policies/${req.query.policyId}/attach_policy_to_user`,
