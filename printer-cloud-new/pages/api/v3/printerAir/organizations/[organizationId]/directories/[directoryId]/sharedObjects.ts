...
import { IndexSharedObjectDirectoriesAPIResponse } from '../../../../../../../../services/printer-air/types/sharedObject';

const transformIndexData = (data): IndexSharedObjectDirectoriesAPIResponse => {
  return {
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .get(
      `/v3/printer_air/organizations/${req.query.organizationId}/directories/${req.query.directoryId}/shared_objects`,
      config
    )
    .then((response) => {
