...
import { CreateProcedureAPIResponse } from '../../../../../../services/printer-flow/types';

const transformCreateData = (data): CreateProcedureAPIResponse => {
  return {
    id: data.id,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .post(
      `/v3/printer_flow/group_requesters/${req.query.id}/procedures`,
