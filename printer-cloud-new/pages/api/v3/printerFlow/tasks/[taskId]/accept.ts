...
import { AcceptTaskAPIResponse } from '../../../../../../services/printer-flow/types';

const transformData = (data): AcceptTaskAPIResponse => {
  return {
    id: data.id,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .put(`/v3/printer_flow/tasks/${req.query.taskId}/accept`, {}, config)
    .then((response) => {
