...
import { DeactivateTaskTemplateAPIResponse } from '../../../../../../services/printer-flow/types';

const transformData = (data): DeactivateTaskTemplateAPIResponse => {
  return {
    id: data.id,
    name: data.name,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .put(
      `/v3/printer_flow/task_templates/${req.query.taskTemplateId}/deactivate`,
