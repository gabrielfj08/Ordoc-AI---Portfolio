...
import { CreatedProcedureReportsAPIResponse } from '../../../../../../services/printer-flow/types';

const transformData = (data): CreatedProcedureReportsAPIResponse => {
  return {
    id: data.id,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  return client
    .post(
      `/v3/printer_flow/procedures/${req.query.procedureId}/procedure_reports`,
      {},
      config
    )
    .then((response) => {
