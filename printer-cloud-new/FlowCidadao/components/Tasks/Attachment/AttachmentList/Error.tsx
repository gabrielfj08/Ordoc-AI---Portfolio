...
const AttachmentExternalTaskListError = () => {
  ...
  return (
    ...
    >
      ...
      <Typography
        ...
        align="center"
      >
        Erro! Não foi possível carregar os anexos. Tente novamente mais tarde.
      </Typography>
    </div>
  );
};

export default AttachmentExternalTaskListError;
