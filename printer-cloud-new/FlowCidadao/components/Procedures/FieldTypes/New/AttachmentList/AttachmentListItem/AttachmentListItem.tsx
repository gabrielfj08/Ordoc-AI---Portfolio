...
import { NewProcedureAttachmentUploadListItemProps } from './types';
import UploadStatusIcon from '../../../../../UploadStatusIcon';

const NewProcedureAttachmentUploadListItem = ({
  item,
  color,
  onClose,
  itemVisibility,
}: NewProcedureAttachmentUploadListItemProps) => {
  return (
    <div
...
export default NewProcedureAttachmentUploadListItem;
