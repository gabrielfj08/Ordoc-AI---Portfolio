...
import { NewProcedureAttachmentUploadListContainerProps } from './types';
import AttachmentList from './AttachmentList';

const appEnv = getConfig().publicRuntimeConfig.NEXT_PUBLIC_APP_ENV;

const NewProcedureAttachmentListContainer = ({
  fieldName,
  color,
  fileList,
  procedure,
...
}: NewProcedureAttachmentUploadListContainerProps) => {
...
export default NewProcedureAttachmentListContainer;
