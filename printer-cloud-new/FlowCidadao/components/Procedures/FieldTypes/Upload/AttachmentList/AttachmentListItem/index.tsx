...
import { UploadProcedureAttachmentUploadListItemContainerProps } from './types';
...
const UploadProcedureAttachmentUploadListItemContainer = ({
  fieldName,
  formik,
  color,
  procedureId,
...
}: UploadProcedureAttachmentUploadListItemContainerProps) => {
...
export default UploadProcedureAttachmentUploadListItemContainer;
