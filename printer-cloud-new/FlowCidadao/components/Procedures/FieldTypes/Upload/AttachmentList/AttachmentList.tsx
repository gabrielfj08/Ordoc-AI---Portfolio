...
import { UploadProcedureAttachmentUploadListProps } from './types';
import AttachmentListItem from './AttachmentListItem';

const UploadProcedureAttachmentUploadList = React.forwardRef(
  (
    {
      fieldName,
      formik,
    ...
    }: UploadProcedureAttachmentUploadListProps,
    ref
  ) => {
...
export default UploadProcedureAttachmentUploadList;
