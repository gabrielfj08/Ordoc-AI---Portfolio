...
import { UploadProcedureFieldTypesProps } from './types';
...
import AttachmentListContainer from './AttachmentList';
import { Field } from 'formik';
import UploadStatusIcon from '../../../UploadStatusIcon';

const UploadProcedureFieldTypes = ({
  formik,
  type,
  color,
  fieldName,
...
}: UploadProcedureFieldTypesProps) => {
...
export default UploadProcedureFieldTypes;
